...
replacements = [
    ...
    ["K", "13"],
    ["Q", "12"],
    ["J", "01"], # Jokers are the lowest value
    ["T", "10"],
    ["9", "09"],
    ["8", "08"],
    ["7", "07"],
...
for hand in input:
    ...
    # add jokers to one of the maximums
    num_jokers = hand[0].count("J")
    i_max = card_counts.index(max(card_counts))
    card_counts[i_max] += num_jokers
